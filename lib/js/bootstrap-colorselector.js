...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      var selectColor = $selectedOption.data("color");
      var selectTitle = $selectedOption.text();
      ...
      var $markupSpan = $("<span>").addClass("btn-colorselector").css("background-color", selectColor).attr("title", selectTitle);
      ...
      this.$select.on("change", function() {
        ...
        $(this).next().find(".btn-colorselector").css("background-color", color).attr("title", title);
